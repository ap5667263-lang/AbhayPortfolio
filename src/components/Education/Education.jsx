...
const timeline = [
  ...
  },
  {
    ...
    year: "2025–26",
    grade: "BBD University, Lucknow",
    status: "attended",
    desc: "Attended Larnovate — a tech fest held at BBD University. Participated in workshops, tech talks, and innovation challenges.",
  },
  {
    id: "05",
    icon: <FaBriefcase color="#34d399" />,
    type: "Internship",
    school: "Grasstech OVT Limited",
    year: "Completed",
    grade: "Software Development Intern",
    status: "completed",
    desc: "Completed internship at Grasstech OVT Limited. Gained hands-on experience in software development, working on real-world projects and industry practices.",
  },
];
